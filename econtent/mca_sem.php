...
<style type="text/css">
    .section {
        background: url("http://127.0.0.1/images/sem.jpg") no-repeat center top fixed;
            ...
            <div class="row my-4">
                ...
                <div class="col-md-4 col-sm-6 mt-2">
                    <div class="card">
                        ...
                        <a href='econtent_mca/emcasem1.php'>
                            <div class="details">
                                <div class="content">
                ...
                <div class="col-md-4 col-sm-6 mt-2">
                    <div class="card">
                        ...
                        <a href='econtent_mca/emcasem2.php'>
                            <div class="details">
                                <div class="content">
                ...
                <div class="col-md-4 col-sm-6 mt-2">
                    <div class="card">
                        ...
                        <a href='econtent_mca/emcasem3.php'>
                            <div class="details">
                                <div class="content">
            ...
            <div class="row my-5">
                ...
                <div class="col-md-4 col-sm-6 mb-3">
                    <div class="card">
                        ...
                        <a href='econtent_mca/emcasem4.php'>
                            <div class="details">
                                <div class="content">
                ...
                <div class="col-md-4 col-sm-6 mb-3 ">
                    <div class="card">
                        ...
                        <a href='econtent_mca/emcasem5.php'>
                            <div class="details">
                                <div class="content">
                                    <h2 style="margin-left:68px;margin-right:0;">SEMESTER V</h2>
