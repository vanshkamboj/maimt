...
<style type="text/css">
 .section{
    background: url("../images/syllabus.jpg") no-repeat center top fixed;
          ...
          <div class="col-md-2"></div>
           <div class="col-md-4 col-sm-6 mr-2 mt-2">
                <div class="card">
                    ...
                    <a href="BCA/paper_sem.php"  target="_blank" class="link"><div class="details">
                        <div class="content">
            ...
            <div class="col-md-4 col-sm-6 mr-2 mt-2">
               <div class="card">
                    ...
                    <a href="BBA/paper_bba_sem.php"  target="_blank" class="link"><div class="details">
                        <div class="content">
          ...
          <div class="col-md-2"></div>
            <div class="col-md-4 col-sm-6 mr-2 mt-2">
               <div class="card">
                    ...
                    <a href="MCA/paper_mca_sem.php"  target="_blank" class="link"><div class="details">
                        <div class="content">
            ...
            <div class="col-md-4 col-sm-6 mr-2 mt-2">
                <div class="card">
                    ...
                    <a href="MBA/paper_mba_sem.php"  target="_blank" class="link"><div class="details">
                        <div class="content">
