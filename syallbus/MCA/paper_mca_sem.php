...
<style type="text/css">
    .section {
        background: url("http://192.168.1.12/images/sem.jpg") no-repeat center top fixed;
            ...
            <div class="row my-4">
                ...
                <div class="col-md-4 col-sm-6 mt-2">
                    <div class="card">
                        ...
                        <a href='MCA 1st Semester/paper_mcasem1.php'>
                            <div class="details">
                                <div class="content">
                ...
                <div class="col-md-4 col-sm-6 mt-2">
                    <div class="card">
                        ...
                        <a href='MCA 2nd Semester/paper_mcasem2.php'>
                            <div class="details">
                                <div class="content">
                ...
                <div class="col-md-4 col-sm-6 mt-2">
                    <div class="card">
                        ...
                        <a href='MCA 3rd Semester/paper_mcasem3.php'>
                            <div class="details">
                                <div class="content">
            ...
            <div class="row my-5">
                ...
                <div class="col-md-4 col-sm-6 mb-3">
                    <div class="card">
                        ...
                        <a href='MCA 4th Semester/paper_mcasem4.php'>
                            <div class="details">
                                <div class="content">
                ...
                <div class="card">
                    ...
                    <a href='paper_mcasem5.php'><div class="details">
                        <div class="content">
                ...
                <div class="col-md-4 col-sm-6 mb-3 ">
                    <div class="card">
                        ...
                        <a href='MCA 5th Semester/paper_mcasem5.php'>
                            <div class="details">
                                <div class="content">
                                    <h2 style="margin-left:68px;margin-right:0;">SEMESTER V</h2>
