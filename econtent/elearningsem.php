          ...
          <!-- <div class="col-md-2"></div> -->
            <div class="col-md-4 col-sm-6 mt-2">
                <div class="card">
                    ...
                    <a href='econtent_bca/ebcasem1.php'><div class="details">
                        <div class="content">
            ...
            <div class="col-md-4 col-sm-6 mt-2">
                <div class="card">
                    ...
                    <a href='econtent_bca/ebcasem2.php'><div class="details">
                        <div class="content">
            ...
            <div class="col-md-4 col-sm-6 mt-2">
                <div class="card">
                    ...
                    <a href='econtent_bca/ebcasem3.php'><div class="details">
                        <div class="content">
          ...
          <!-- <div class="col-md-2"></div> -->
            <div class="col-md-4 col-sm-6 mb-3">
                <div class="card">
                    ...
                    <a href='econtent_bca/ebcasem4.php'><div class="details">
                        <div class="content">
            ...
            <div class="col-md-4 col-sm-6 mb-3">
                <div class="card">
                    ...
                    <a href='econtent_bca/ebcasem5.php'><div class="details">
                        <div class="content">
            ...
            <div class="col-md-4 col-sm-6 mb-3 ">
                <div class="card">
                    ...
                    <a href='econtent_bca/ebcasem6.php'><div class="details">
                        <div class="content">
